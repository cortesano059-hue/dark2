    ...
    async run(interaction) {
        ...
        if (sub === "ver") {
            ...
            const embed = new ThemedEmbed()
                ...
                .addFields(
                    { name: '🔢 Nº Dni:', value: data.dni, inline: false },
                    { name: '🪪 Nombre:', value: data.nombre, inline: true },
                    { name: '🪪 Apellido:', value: data.apellido, inline: true },
                    { name: '🎂 Edad:', value: data.edad.toString(), inline: true },
                    { name: '🌍 Nacionalidad:', value: data.nacionalidad, inline: true },
                    { name: '🎮 ID:', value: data.psid, inline: false }
                )
