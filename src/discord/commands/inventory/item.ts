...
createCommand({
    ...
    options: [
        {
            ...
            options: [
                ...
                { name: "descripcion", description: "Descripción", type: ApplicationCommandOptionType.String },
        ...
        {
            name: "info",
            description: "Información detallada del item.",
            type: ApplicationCommandOptionType.Subcommand,
            options: [
        ...
        },
        {
            ...
            options: [
                ...
                { name: "descripcion", description: "Nueva descripción", type: ApplicationCommandOptionType.String },
    ...
    async run(interaction) {
        ...
        switch (sub) {
            case "crear": return handlers.createHandler(interaction);
            case "comprar": return handlers.buyHandler(interaction);
            case "info": return handlers.infoHandler(interaction);
            case "usar": return handlers.useHandler(interaction);
            case "editar": return handlers.editHandler(interaction);
            case "eliminar": return handlers.deleteHandler(interaction);
            case "dar": return handlers.giveHandler(interaction);
            case "quitar": return handlers.removeHandler(interaction);
            case "set": return handlers.setHandler(interaction);
        }
    }
});
