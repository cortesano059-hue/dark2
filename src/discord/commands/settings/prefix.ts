...
createCommand({
    ...
    async run(interaction) {
        ...
        const embed = ThemedEmbed.success("Prefijo Actualizado", `El prefijo del servidor ha sido cambiado con éxito.\nAhora puedes usar comandos con: \`${newPrefix}\``)
            .addFields({ name: "Ejemplo", value: `\`${newPrefix}help\`` })
