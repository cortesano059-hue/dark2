...
class BaseResponderHandlers {
  ...
  static async handler(interaction) {
    ...
    const params = handler.params && handler.data.parse ? handler.data.parse(handler.params) : handler.params;
    let isBlock = false;
