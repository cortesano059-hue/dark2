...
createCommand({
  ...
  async run(interaction) {
    ...
    const embed = new ThemedEmbed().setTitle("\u{1F6E1}\uFE0F Fuera de Rol (OOC)").setColor("#95A5A6").setDescription(text).setFooter({ text: interaction.user.displayName, iconURL: interaction.user.displayAvatarURL() });
