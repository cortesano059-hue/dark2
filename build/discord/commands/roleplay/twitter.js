...
createCommand({
  ...
  async run(interaction) {
    ...
    const embed = new ThemedEmbed().setAuthor({ name: `@${interaction.user.username}`, iconURL: "https://cdn-icons-png.flaticon.com/512/733/733579.png" }).setTitle("\u{1F426} Nuevo Tweet").setDescription(text).setColor("#1DA1F2").setFooter({ text: "Twitter for Discord", iconURL: interaction.user.displayAvatarURL() });
